...
def mock_globals():
  ...
  mock_drop_downs = {
    ...
    "ogi_result": ["Unintentional-leak", "Unintentional-non-component", "Venting-construction/maintenance", "Venting-routine", "Not applicable as OGI was not performed"],
    "method21_performed": ["Yes", "No"],
    "method21_result": ["Unintentional-leak", "Unintentional-non-component", "Venting-construction/maintenance", "Venting-routine", "Not applicable as Method 21 was not performed"],
