...
def test_route_function_signatures():
    ...
    from arb.portal.routes import upload_file_staged, upload_file_staged_refactored
    ...
    import inspect
    original_sig = inspect.signature(upload_file_staged)
    refactored_sig = inspect.signature(upload_file_staged_refactored)
    
    # Both should accept message parameter
    assert 'message' in original_sig.parameters
    assert 'message' in refactored_sig.parameters 