...
Following this protocol ensures that documentation serves as both human-readable guidance and machine-readable metadata for automation tools.
...
- **Supplemental Notes**: Personal insights marked with "[PERSONAL NOTES - DO NOT MODIFY]" that should not be changed by AI
...
*This protocol ensures that documentation serves both human readers and automated tools, enabling better testing, clearer APIs, and more maintainable codebases.* 