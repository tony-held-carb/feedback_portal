...
from arb.auth_example_app.extensions import db, mail, login_manager

# Import the auth package
from arb.auth import init_auth, register_auth_blueprint, get_db

# Import routes
from arb.auth_example_app.routes import main, admin, user_management
