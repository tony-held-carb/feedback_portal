...
from arb.utils.date_and_time import repr_datetime_to_string, date_to_string
...
def db_create(flask_app: Flask, db: SQLAlchemy) -> None:
    ...
    """
    # Warning: Required for model registration
    # noinspection PyUnresolvedReferences
...
def db_initialize_and_create(flask_app: Flask, db: SQLAlchemy) -> None:
    ...
    # db_drop_all(flask_app)  # Danger: Uncomment to delete all tables
