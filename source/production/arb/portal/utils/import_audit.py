...
# Summary Section
# =========================
def summary_section(label_match_count: int, label_mismatch_count: int, value_match_count: int, value_mismatch_count: int, warning_count: int, invalid_input_count: int) -> List[str]:
    """
...
def generate_import_audit(
    ...
    lines.extend(summary_section(label_match_count, label_mismatch_count, value_match_count, value_mismatch_count, warning_count, invalid_input_count))
    lines.extend(machine_readable_summary(import_id, label_match_count + label_mismatch_count, warning_count, invalid_input_count, import_time))
    if notes:
