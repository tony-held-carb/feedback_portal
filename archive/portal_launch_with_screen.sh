...
#   ./portal_launch_with_screen.sh                        # defaults to flask, 0.0.0.0:2113, debug=true
#   ./portal_launch_with_screen.sh gunicorn               # gunicorn with defaults
#   ./portal_launch_with_screen.sh flask 0.0.0.0 5000 true
#   ./portal_launch_with_screen.sh gunicorn 127.0.0.1 8000 false
#
# ARGS:
