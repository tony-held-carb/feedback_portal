...
echo ======================================== >> "%OUTPUT_FILE%"
nslookup cursor.sh >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
nslookup github.com >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
...
tasklist /fi "imagename eq vpnui.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq vpncli.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq cisco*" >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"

echo Checking VPN registry entries... >> "%OUTPUT_FILE%"
reg query "HKLM\SOFTWARE\Cisco Systems" /s 2>nul >> "%OUTPUT_FILE%"
reg query "HKLM\SOFTWARE\WOW6432Node\Cisco Systems" /s 2>nul >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
...
echo ======================================== >> "%OUTPUT_FILE%"
reg query "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyEnable >> "%OUTPUT_FILE%"
reg query "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyServer >> "%OUTPUT_FILE%"
reg query "HKCU\Software\Microsoft\Windows\CurrentVersion\Internet Settings" /v ProxyOverride >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
...
tasklist /fi "imagename eq msseces.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq mcshield.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq avast.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq avgui.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq norton.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq kav.exe" >> "%OUTPUT_FILE%"
tasklist /fi "imagename eq kavsvc.exe" >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
...
reg query "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\chrome.exe" 2>nul >> "%OUTPUT_FILE%"
reg query "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\firefox.exe" 2>nul >> "%OUTPUT_FILE%"
reg query "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\msedge.exe" 2>nul >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
...
ping -n 1 cursor.sh >> "%OUTPUT_FILE%"
ping -n 1 github.com >> "%OUTPUT_FILE%"
ping -n 1 api.github.com >> "%OUTPUT_FILE%"
echo. >> "%OUTPUT_FILE%"
